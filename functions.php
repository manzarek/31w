...
function ajouter_styles() {
    wp_enqueue_style('31w-style-principal', // id de la feuille de style
                ...
                filemtime(get_template_directory() . '/style.css')); // la date de la dernière feuille de style
}
...
if (    $query->is_home() // si page d'accueil
  ...
  $query->set( 'category_name', 'note-wp' ); // filtre les artcles de catégorie note-wp
